...
public class DrugController {
    ...
    @RequestMapping(value="/findallbytypeid",method = RequestMethod.GET)
    @ApiOperation("通过药品类型ID查询对应药品")
    public List<Druginfor> findallbytypeid(int typeid){
        //Druginfor druginfor= drugService.findallbytypeid(typeid);
        // return druginfor;
        List<Druginfor> druginforList=drugService.findallbytypeid(typeid);
        return druginforList;
    }
}
